...
const ChooseModal = (props) => {
  ...
  return props.isOpen ? (
    ...
    >
      <div
        className="z-10 p-8 bg-white border rounded modal"
        style={{
          top: '50%',
          left: '50%',
          position: 'relative',
      ...
      >
        ...
        >
          ...
          >
            <div className="flex">
              <div className="text-lg border-b">Выберите элементы</div>
              <button
            ...
            />
            <div
              className="flex flex-wrap w-full container-model-choose"
              style={
                items.length > 0
                  ? {}
                  : {
            ...
            >
              {selectedItem?.map((elem) => (
                <div
                  ...
                  className="flex smile align-center flex-nowrap"
                >
