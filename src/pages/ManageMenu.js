        ...
        <div className="center-block">
          <div className="flex flex-col flex-wrap">
            ...
            <div className="grid manageMenu">
              <div className="p-4 border border-radius">
                <h2 className="font-18 bold-font">Роли студентов</h2>
                <Link
                  to={'/editRoles'}
                  className="flex p-2 color-title font-14 align-center gap"
                >
              ...
              <div className="p-4 border border-radius">
                ...
                <Link className="p-4 color-title font-14">
                  Перейти к редактированию
                </Link>
              </div>
              <div className="p-4 border border-radius">
                <h2 className="font-18 bold-font">Профили подготовки</h2>
                <Link to={'/editProfile'} className="p-4 color-title font-14">
                  Перейти к редактированию
                </Link>
              </div>
              <div className="p-4 border border-radius">
